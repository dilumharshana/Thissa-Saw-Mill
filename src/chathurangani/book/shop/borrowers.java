        ...
        try {
            if (!(MAIN_FRAME.staticTotal.getText().trim()).equals("")) {
                ...
                if (rowcount > 0) {
                    ...
                    BigDecimal[] values = {current_value[0].add(discountGet), current_value[1].add(totalGet), current_value[2].add(MAIN_FRAME.cashpriceAmount)};
                    ...
                    if (dateAvailability == true) {
                        ...
                        BigDecimal updated_cashPrice = MAIN_FRAME.cashpriceAmount.add(controllers.cashPrice);
                        ...
                        String cashprice_is = String.valueOf(MAIN_FRAME.cashpriceAmount);
                        connect.Strore_incomedata(cashprice_is, MAIN_FRAME.total.getText(), "0.0", "0.0", String.valueOf(java.time.LocalDate.now()));
                    }
                    ...
                    for (int i = 0; i < rowcount; i++) {
                        ...
                        if (!cheker.equals("")) {
                            ...
                            pk = dealTable.getValueAt(borrowerRow, 0).toString();
                            code = MAIN_FRAME.selltable.getValueAt(i, 0).toString();
                            name = MAIN_FRAME.selltable.getValueAt(i, 1).toString();
                            ...
                            connect.storeDealItemsIntoDataBase(pk, code, name, quantity, price);
