  ...
  //process of new cashier
     void sendData(boolean cashier) throws Exception {
         ...
         if(passbox.getText().length()>0)
         {
               ...
               String [] newBorro = {controllers.primaryKeyOfdealsData , CusNameForBill.getText().trim(), cusphoneForBill.getText().trim(), nic.getText().trim() , address.getText().trim() ,  passbox.getText().trim(),  String.valueOf(java.time.LocalDate.now())};
               delas.addRow(newBorro);
